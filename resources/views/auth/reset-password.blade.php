...
<head>
    ...
    <title>{{ $settings->site_name }} - Reset your password</title>
                ...
                <div class="mb-8">
                    <div class="w-20 h-20 bg-white/10 backdrop-blur-sm rounded-2xl flex items-center justify-center border border-white/20 shadow-xl">
                        @if(isset($settings->favicon) && $settings->favicon)
                            <img src="{{ asset('storage/' . $settings->favicon) }}" alt="{{ $settings->site_name }}" class="w-10 h-10 object-contain">
                        @else
            ...
            <div class="w-full max-w-md">
                ...
                <div class="lg:hidden mb-8 text-center">
                    <div class="w-16 h-16 bg-brand-100 rounded-2xl flex items-center justify-center mx-auto mb-4">
                        @if(isset($settings->favicon) && $settings->favicon)
                            <img src="{{ asset('storage/' . $settings->favicon) }}" alt="{{ $settings->site_name }}" class="w-8 h-8 object-contain">
                        @else
                ...
                <form method="POST" action="{{ route('password.update') }}" class="space-y-5">
                    ...
                    <button
                        type="submit"
                        class="w-full flex items-center justify-center gap-2 px-4 py-3 bg-brand-600 hover:bg-brand-700 text-white font-semibold rounded-xl transition-all duration-200 shadow-lg shadow-brand-500/25 hover:shadow-brand-500/40"
                    >
