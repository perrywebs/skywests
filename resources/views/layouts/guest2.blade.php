...
<head>
    ...
    <style>
        ...
        .preloader-ring-inner {
            ...
            border-radius: 50%;
            border: 3px solid transparent; border-bottom-color: var(--secondary);
        ...
        .floating-slower { animation: floating 10s ease-in-out infinite; }
...
<body class="font-sans bg-slate-50 text-slate-900 antialiased">
    ...
    <script>
        window.addEventListener('load', function() {
            ...
            if (p) { setTimeout(function() { p.classList.add('loaded'); setTimeout(function() { p.remove(); }, 500); }, 400); }
        });
        setTimeout(function() {
            var p = document.getElementById('preloader');
            if (p && !p.classList.contains('loaded')) { p.classList.add('loaded'); setTimeout(function() { p.remove(); }, 500); }
        }, 3500);
    </script>
