                                ...
                                <div>
                                    ...
                                    <div class="relative rounded-md shadow-sm">
                                        ...
                                        <select name="income" id="income"
                                            ...
                                            <option value="$300,000.00 - $1,000,000.00">$300,000.00 - $1,000,000.00
                                            </option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="mb-6">
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    ...
                                    <div class="relative bg-white border border-gray-200 p-4 rounded-lg shadow-sm hover:border-primary-500 cursor-pointer document-type-card"
                                        ...
                                        <input type="radio" name="document_type" id="passport-radio"
                                            value="Int'l Passport" class="absolute opacity-0" checked>
                                    ...
                                    <div class="relative bg-white border border-gray-200 p-4 rounded-lg shadow-sm hover:border-primary-500 cursor-pointer document-type-card"
                                        ...
                                        <input type="radio" name="document_type" id="national-id-radio"
                                            value="National ID" class="absolute opacity-0">
                                    ...
                                    <div class="border border-dashed border-gray-300 rounded-lg p-4 text-center hover:bg-gray-50 transition-colors"
                                        ...
                                        <label for="frontimg" class="cursor-pointer block" id="frontimg-label">
                                            <i data-lucide="upload-cloud"
                                                class="h-10 w-10 text-gray-400 mx-auto mb-2"></i>
                                        ...
                                        <div class="hidden mt-3" id="frontimg-preview-container">
                                            <img id="frontimg-preview" class="mx-auto max-h-40 rounded-lg shadow-sm"
                                                src="" alt="ID front preview">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
                                    <div class="border border-dashed border-gray-300 rounded-lg p-4 text-center hover:bg-gray-50 transition-colors"
                                        ...
                                        <div class="hidden mt-3" id="backimg-preview-container">
                                            <img id="backimg-preview" class="mx-auto max-h-40 rounded-lg shadow-sm"
                                                src="" alt="ID back preview">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
                                    <div class="border border-dashed border-gray-300 rounded-lg p-4 text-center hover:bg-gray-50 transition-colors"
                                        ...
                                        <div class="hidden mt-3" id="photo-preview-container">
                                            <img id="photo-preview" class="mx-auto max-h-40 rounded-lg shadow-sm"
                                                src="" alt="Passport photo preview">
