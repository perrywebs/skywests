...
<div class="flex flex-col lg:flex-row min-h-screen">
    ...
    <div class="hidden lg:flex lg:w-[45%] bg-gradient-to-br from-brand-600 via-brand-700 to-brand-900 relative overflow-hidden">
        ...
        <div class="relative flex flex-col justify-center items-center w-full h-full text-white p-12 z-10">
            ...
            <h1 class="text-4xl font-extrabold mb-5 text-center font-display leading-tight">Manager<br>Portal</h1>
            <p class="text-lg mb-12 max-w-sm text-center text-white/60 leading-relaxed">
                Secure access to your {{ $settings->site_name }} banking administration dashboard.
            </p>
        ...
        <div class="w-full max-w-md animate-fade-in-up">
            ...
            <div class="bg-white rounded-2xl shadow-xl shadow-slate-900/5 border border-slate-100 overflow-hidden">
                <div class="px-8 pt-8 pb-6">
                    <h2 class="text-2xl font-bold text-slate-900 font-display">Manager Login</h2>
                    <p class="mt-2 text-sm text-slate-400">Secure access to your banking administration</p>
                </div>
                    ...
                    <form method="POST" action="{{ route('adminlogin') }}">
                        ...
                        <div class="mb-7">
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <a href="{{ route('admin.forgetpassword') }}" class="text-xs font-medium text-brand-600 hover:text-brand-700 transition-colors">Forgot password?</a>
                            </div>
